...
import SingelBlog from './Componet/All_Blog/SingelBlogs/SingelBlog';
...
const App = () => {
  ...
  const [them, setThem] = useState( current_them ? current_them : 'ligth')
  useEffect (()=>{
  ...
  return (
    < div className={`darkthem ${them}`} >
 
   
    <BrowserRouter>
    <Navigation them={them} setThem={setThem} />
